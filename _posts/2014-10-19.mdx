...
<Alert>
  <CircleAlert />
  <AlertDescription>
    At this point, an assumption needs to be made about whether a. the screen
    text is wrong, or b. the appointments got pushed back. We'll be going with
    the latter, as editing and cutting getting rescheduled could still have been
    decided off-screen, especially given the crunch time circumstances at MusAni
    at this time.
  </AlertDescription>
</Alert>

Later, Aoi tries to leave for the episode 9 cutting, another conflict with what past-Aoi said (should also have happened on the 17th), and for the same day at that.
